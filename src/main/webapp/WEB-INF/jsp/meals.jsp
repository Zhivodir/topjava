...
<script type="text/javascript" src="resources/js/datetimepickerScripts.js" defer></script>
...
<script>
    function saveMeal() {
        var dateTimeWithOutT = $("#dateTime").val();
        $("#dateTime").val(dateTimeWithOutT.replace(" ","T"));
        save();
    }
</script>
</html>
